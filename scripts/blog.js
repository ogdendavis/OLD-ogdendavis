...
class Blog extends React.Component {
  ...
  containInactiveThumbs(allPosts, isAnyActive) {
    ...
    const morePosts = isAnyActive === true ?
      <div className='thumbnail thumbnail--doublewide' style={{background: 'var(--orange-transparent), url(images/lucas-in-park-wide.jpg)', backgroundPosition: '50% 50%', backgroundRepeat: 'no-repeat', backgroundSize: 'cover', cursor: 'default', color: '#222'}}>
